...
>
> **Сценарий поднятия инфраструктуры с нуля - [runbook-yc-ru.md](runbook-yc-ru.md).** Появился из-за частых циклов destroy/redeploy в процессе работы (бюджет купона ограничен) и теперь даёт пошаговый план для воспроизведения всей системы.
>
