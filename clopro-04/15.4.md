...
MySQL кластер clopro-dev-mysql-cluster: хосты в разных зонах (MASTER в ru-central1-a, REPLICA в ru-central1-b)

![alt text](screenshots/yc/05.png)

окружение PRESTABLE, b1.medium (50% CPU), диск 20 Гб. Бэкап: 23:59 UTC
...
IAM: сервис-аккаунт clopro-dev-k8s-cluster-sa ("ajeeg5rggsgtpv6i946k") с ролями k8s.clusters.agent, vpc.publicAdmin, load-balancer.admin
