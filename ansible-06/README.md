...
P.S. При повторном запуске мы видим что одна из задач отмечена всегда как changed, потому что Ansible не может понять, изменил ли наш DDL что-то в ClickHouse. 
