defmodule ShopSessionsWeb.UserAuthTest do
  use ShopSessionsWeb.ConnCase, async: true

  alias ShopSessions.Accounts
  alias ShopSessions.Accounts.Scope
  alias ShopSessionsWeb.UserAuth

  import ShopSessions.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ShopSessionsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
