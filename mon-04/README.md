...
Для python у меня не получилось сгенерировать тестовое событие на сайте - поэтому я сгенерировала его из кода - согласно инструкции.
...
Было проделано выше в основных заданиях для python-проект.

Попробовала еще для другого ЯП. :)
